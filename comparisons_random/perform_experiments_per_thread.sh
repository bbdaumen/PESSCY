...
chmod 777 ./comparisons_random/perform_experiments.py
...
while [ "$TEST_NUM" -ne "0" ]; do
  ...
  python3 ./comparisons_random/perform_experiments.py $FOLDER_WORKING $TEST_NUM $TIMEOUT_SYSTEM_GENERATION $TIMEOUT_FULL_COMPUTATION
